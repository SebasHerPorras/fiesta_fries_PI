...
{
    public class EmailEmployeeNotificationRepository
    {
        private readonly string _connectionString;
        public EmailEmployeeNotificationRepository()
        {
        ...
        private void sendEmail(MailRepository mailRepository, MailModel mailTokenVerification,UserModel request)
        {
