...
CREATE TABLE [Fiesta_Fries_DB].[PersonalIncomeTax](
    Id INT IDENTITY(1,1) PRIMARY KEY,
    [Name] VARCHAR(100) NOT NULL, -- Ej: "Escala 1", "Escala 2", etc.
    MinAmount DECIMAL(18,2) NOT NULL, -- Monto m�nimo del rango
    MaxAmount DECIMAL(18,2) NULL, -- Monto m�ximo del rango (NULL para el �ltimo rango)
...
INSERT INTO [Fiesta_Fries_DB].[PersonalIncomeTax] ([Name], MinAmount, MaxAmount, [Percentage], BaseAmount, [Active])
VALUES 
    ...
    ('Escala 5', 4745001.00, NULL, 0.25, 670550.00, 1);        -- 25% m�s de 4,745,000
GO