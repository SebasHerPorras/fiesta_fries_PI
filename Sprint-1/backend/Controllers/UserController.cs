...
namespace backend.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public ActionResult Login([FromBody] LoginRequest request)
        {
            ...
            // Si es admin, retornar solo datos b�sicos
            if (user.admin == true)
            {
        ...
        {
            Console.WriteLine("Entro en el m�todo de creaci�n de usuario\n");
            ...
            const string query = @"INSERT INTO [Fiesta_Fries_DB].[User] (PK_User , email, password) VALUES (@Id, @Email, @PasswordHash)";
            ...
            //Ojito pq aqu� vamos a a�adir la vara del correo electr�nico 

            // vamos a generar el token 

            var token = Guid.NewGuid().ToString();

            // La expiraci�n va a ser cada 3 d�as
            ...
            //Justo aqu� tengo que conectarme para modificar la tabla, realzar un insert
            ...
            const string subject = "Verificaci�n de Creaci�n de usuario Fiesta Fries";

            string body = $"�Saludos cordiales!, somos la gente de Fiesta Fries enviandote el enlace de verficaci�n de usuario para finalizar el proceso de creaci�n de tu cuenta: {verificationLink}";
        ...
        //Api para la validaci�n de usuari
        [HttpGet("verify")]
        public ActionResult verification([FromQuery] string token)
        {
            ...
            /// Aqu� hacemos las validaciones para el token
            /// 
            if (verificationMail == null || verificationMail.experationDate < DateTime.UtcNow)
            {
                return BadRequest("El token es nulo o ya caduc�");
            }

            /// Necesito verificarlo
            /// objeto para realizar la verificaci�n
            ...
            const string query = @"UPDATE [Fiesta_Fries_DB].[User] SET active = @active WHERE PK_User = @userFk";
