        ...
        <header class="header">
            <nav class="nav">
                ...
                <ul class="nav-list">
                    ...
                    <li><router-link to="/country">Agregar País</router-link></li>
                    <li><router-link to="/countries">Lista de Países</router-link></li>
                    <!-- Botón cerrar sesion sin implementar aun -->
                    <li><router-link to="/">Cerrar Sesión</router-link></li>
                </ul>
            </nav>
        </header>

        <!-- Discutir que añadir por default (Vacío vs Info base vs Funcionalidad) -->
        <section class="hero">
            <div class="brand">
                <div class="texts">
                    <h1> Homepage </h1>
                    <p> Nuestra herramienta permite gestionar el pago
                        de planillas de forma total y automatizada </p>
                </div>
            </div>
        </section>
